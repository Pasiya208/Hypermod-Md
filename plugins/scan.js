let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    if (!args || !args[0] || args.length === 0) throw `හ්ම්.. මොන නම්බර් එකද?\n\nඋදාහරණයක්:\n${usedPrefix + command} 94767043432`

    if (args[0].startsWith('0')) throw 'රටේ කේතය භාවිතා කරන්න!'
...
*Whatsapp Bussines:* ${user.isBusiness ? 'Yes' : 'Not'}

*In Database:* ${isInDatabase ? 'Yes' : 'Not'}
...
`.trim()
    ...
    } else throw 'ලියාපදිංචි නොකළ අංකය'
