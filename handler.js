            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    try {
                        ...
                        if (m.limit) m.reply(+ m.limit + ' ලිමිට් එකක් වැයවේ ⏳')
                    }
                    break
                }
            }
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'බොසාට විතරයි!1!1!*_',
        owner: 'බොසාටබ්විතරයි_!',
        mods: 'මෙම විධානය භාවිතා කළ හැක්කේ _*Moderator*_ හට පමණි!',
        premium: 'PREMIUM USER ONLY*_ !',
        group: 'ගෲප් සදහා පමනි!',
        private: 'මෙම විධානය භාවිතා කළ හැක්කේ පුද්ගලික කතාබස් වල පමණි!',
        admin: 'ගෲපේ *Admin* සදහා පමනි!',
        botAdmin: 'මෙම විධානය භාවිතා කිරීමට bot *Admin* ලෙස සාදන්න!',
        unreg: 'ටයිප් කිරීමෙන් මෙම විශේෂාංගය භාවිතා කිරීමට කරුණාකර ලියාපදිංචි වන්න:\n\n*#daftar name.age*\n\nඋදාහරණයක්: *#daftar Lakshitha.16*',        
        restrict: 'ඔව්නර් විසින් නවතා ඇත!'
    }[type]
